...
import modeling_finetune_ego4d
...
def get_args():
    ...
    parser.add_argument('--nb_verb_classes', default=118, type=int,
                        help='number of the classification types')
    parser.add_argument('--nb_noun_classes', default=582, type=int,
                        help='number of the classification types')
...
def main(args, ds_init):
    ...
    dataset_train, args.nb_verb_classes, args.nb_noun_classes = build_dataset(is_train=True, test_mode=False, args=args)
    ...
    # baselr=1e-5 batchsize=512
    # args.lr = args.lr * total_batch_size / 1
    # args.min_lr = args.min_lr * total_batch_size / 1
    # args.warmup_lr = args.warmup_lr * total_batch_size / 1
    print("LR = %.8f" % args.lr)
    ...
    if args.eval:
        ...
        if args.test_subset == "test":
            dl = data_loader_test
        elif args.test_subset == "val":
            dl = data_loader_val
        else:
            raise NotImplementedError
